...
void IMU::update_state(float Ts, double *roll_ptr, double *pitch_ptr, double *roll_vel_ptr, double *pitch_vel_ptr)
{
  ...
  roll_acc = -acc2roll(imu.calcAccel(ax), imu.calcAccel(ay), imu.calcAccel(az)) -0.01047;//-0.00873;// - 0.0271;//-0.0175;
  pitch_acc = -acc2pitch(imu.calcAccel(ax), imu.calcAccel(az)) + 0.0267;//0.014;// 0.0297;// + 0.0175;//75  
