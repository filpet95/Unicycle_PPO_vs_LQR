function [upd_states,t] = NL_update_discrete_myode45_model_error(states,input,Ts,tol)
...
odefun = @(t,y)NL_model_model_error(y(1),y(2),y(3),y(4),y(5),y(6),input(1),input(2));
t = 0;
