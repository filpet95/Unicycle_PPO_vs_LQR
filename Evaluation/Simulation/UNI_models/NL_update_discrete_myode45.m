function [upd_states,t] = NL_update_discrete_myode45(states,input,Ts,tol)
...
% odefun = @(t,y)NL_model_V1337(y(1),y(2),y(3),y(4),y(5),y(6),input(1),input(2));
odefun = @(t,y)NL_model_V3(y(1),y(2),y(3),y(4),y(5),y(6),input(1),input(2));
t = 0;
