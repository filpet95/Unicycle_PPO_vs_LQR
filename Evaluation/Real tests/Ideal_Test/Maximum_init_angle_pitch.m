...
stable_lqr = {'Yes','No','No','Yes','No','Yes','Yes','Yes','Yes','Yes',};
stable_dl = {'Yes','Yes','No','Yes','No','Yes','No','Yes','Yes','Yes',};
...
method = 2;
file_to_read = 'DL_20_battery_test' + string(test) + '.csv';
if isequal('LQR',meth)
    method = 1;
    file_to_read = 'LQR_28_battery_test'+ string(test) + '.csv';
end
